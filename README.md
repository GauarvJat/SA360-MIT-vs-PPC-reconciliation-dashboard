...
Overview
This project automates the quality assurance (QA) process for validating media performance data between source advertising platforms and a centralized reporting dashboard(PPC).
